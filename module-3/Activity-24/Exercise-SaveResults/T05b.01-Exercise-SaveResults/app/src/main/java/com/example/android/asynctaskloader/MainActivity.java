...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            String queryresults = savedInstanceState.getString(SEARCH_RESULTS_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String query_results = mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_RESULTS_RAW_JSON, query_results);
    }
}